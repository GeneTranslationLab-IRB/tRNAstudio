...
if (!file.exists("../Results/Modification_Coverage/Modification_Heatmaps_Plots")){
  dir.create("../Results/Modification_Coverage/Modification_Heatmaps_Plots", recursive=TRUE)
}
