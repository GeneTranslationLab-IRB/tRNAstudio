...
if (!file.exists("../Results/Counts_Plots/Processed_vs_Precursor/By_tRNA_family")){
  dir.create("../Results/Counts_Plots/Processed_vs_Precursor/By_tRNA_family", recursive=TRUE)
}

if (!file.exists("../Results/Counts_Plots/Processed_vs_Precursor/By_tRNA_family/Comparison")){
  dir.create("../Results/Counts_Plots/Processed_vs_Precursor/By_tRNA_family/Comparison", recursive=TRUE)
}
...
for(group in groups){
  ...
  ggsave(plot=p, filename=paste0("../Results/Counts_Plots/Processed_vs_Precursor/",
                                 group,"_by_Isodecoder.jpeg"), width = 20, 
         height = 10, units = "cm")
