...
if "Darwin" in o_sys:
	...
	text1.place(x=60, y=60)
	text1.config(font='Calibri 14 bold')

    
	programs_Button=tkinter.Button(tab1, text='Download Genomes', width=15 , height=2,command=download_Genome)
	...
	open_text = tkinter.Button(tab1, text="Indicate sample information", width=19, height=1,
		                   command=create_text)
	open_text.place(x=325, y = 160)
	...
	submit_button = tkinter.Button(tab1, text="Run tRNA pipeline", width = 15, height = 2, command=run_alignment)
...
if "Linux" in o_sys:
	...
	genome_Button=tkinter.Button(tab1, text='Download Genome', width=16, height=1, command=download_Genome)
	genome_Button.place(x=20, y=50)
	genome_Button.config(font=myFont3)

	text1=tkinter.Label(text="Select Samples", width=15, height=1,bg="#F7F7F7")
	text1.place(x=17, y=155)
	text1.config(font='Calibri 12 bold')

	text_Widget = tkinter.Text(height=1, width=12)
	...
	text_Widget.bind("<FocusIn>", default)
	text_Widget.bind("<FocusOut>", default)
	text_Widget.place(x=200, y=190)

	download_Button=tkinter.Button(tab1, text='Download sample:', width=13, height=1, command=retrieve_SRR)
	download_Button.place(x=30, y=160)
	download_Button.config(font=myFont3)

	open_text = tkinter.Button(tab1, text="Indicate sample information", width=25, height=1,
		                   command=create_text)
	open_text.place(x=345, y = 160)
	open_text.config(font=myFont3)

	text1=tkinter.Label(text="tRNA Analysis", width=15, height=1,bg="#F7F7F7")
	text1.place(x=205, y=270)
	text1.config(font='Calibri 12 bold')

	submit_button = tkinter.Button(tab1, text="Run tRNA pipeline", width = 15, height = 2, command=run_alignment)
	submit_button.place(x=200, y=280)
	submit_button.config(font=myFont3)

	b_countsAnalysis=tkinter.Button(tab1, text='Results Report', width=15, height=2, command=r_analysis)
	b_countsAnalysis.place(x=200, y= 350)
	b_countsAnalysis.width=250
	b_countsAnalysis.config(font=myFont3)
